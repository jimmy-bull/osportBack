...
class CreateMshopTextListTypeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mshop_text_list_type', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('mshop_text_list_type');
    }
}
