...
class CreateMshopSupplierListTypeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mshop_supplier_list_type', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('mshop_supplier_list_type');
    }
}
