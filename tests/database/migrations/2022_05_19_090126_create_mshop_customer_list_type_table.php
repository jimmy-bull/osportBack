...
class CreateMshopCustomerListTypeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mshop_customer_list_type', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('mshop_customer_list_type');
    }
}
