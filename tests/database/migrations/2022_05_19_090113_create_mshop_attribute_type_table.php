...
class CreateMshopAttributeTypeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mshop_attribute_type', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('mshop_attribute_type');
    }
}
