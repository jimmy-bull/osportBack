...
class CreateMshopCustomerPropertyTypeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mshop_customer_property_type', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('mshop_customer_property_type');
    }
}
