...
class CreateMshopServiceListTypeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mshop_service_list_type', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('mshop_service_list_type');
    }
}
